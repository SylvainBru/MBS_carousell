...
def user_JointForces(mbs_data, tsim):
    ...
    #hinge_pend2 = mbs_data.joint_id['R2_arm_pend2']  # BUGFIX: R2_arm_pend2 = joint 7 (T1, effort chain) — mauvais joint !
    hinge_pend2 = mbs_data.joint_id['arm_pend2']      # joint 17 : rotation R1 du Pendule2
    ...
    for i, h_id in enumerate(hinges):
        ...
        #d_hinge = D_hinge_normal  # BUGFIX: ignorait le pendule rouillé
        d_hinge = D_hinge_rusted if i == 1 else D_hinge_normal  # i==1 → Pendule2
