...
axis.set_title('Angular velocity around the vertical axis of the main pole')
axis.legend()
fig.tight_layout()
...
axis.set_title('Pendulum angles')
axis.legend()
fig.tight_layout()
...
axis.set_xlabel('Time (s)')
axis.set_ylabel('Angular velocity [deg/s]')
axis.set_title('Pendulum angular velocities')
axis.legend()
fig.tight_layout()
...
axis.set_xlabel('Time (s)')
axis.set_ylabel('Angle [deg]')
axis.set_title('Driven joint angles (pole tilt)')
axis.legend()
fig.tight_layout()
