...
# Project loading
# =============================================================================
mbs_data = Robotran.MbsData('Carroussel/dataR/Carroussel.mbs')
...
mbs_dirdyn.set_options(dt0=1e-3, tf=10.0, save2file=1, verbose=0)
...
# Plotting data's
axis.plot(results.q[:, 0], results.q[:, 4], label='q[1]')
