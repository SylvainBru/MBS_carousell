...
omega, omega_c_dot, alpha_c, beta_c,z, O_M, A_M, R = neri.forward_kinematics(q0, qd0, topology, mbs_data)
W_c, F_c, L_c, Q, W_M, F_M, L_M, M = neri.backward_dynamics(topology, mbs_data,
